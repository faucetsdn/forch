...
_PORTBEHAVIOR_PORTEVENT = _descriptor.EnumDescriptor(
  name='PortEvent',
  full_name='PortBehavior.PortEvent',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_PORTBEHAVIOR_PORTEVENT)
...
_PORTBEHAVIOR_PORTEVENT.containing_type = _PORTBEHAVIOR
