...
_SWITCHSTATE_PORT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state', full_name='SwitchState.Port.state', index=3,
...
_SWITCHSTATE_PORT.fields_by_name['state'].enum_type = forch_dot_proto_dot_shared__constants__pb2._DVASTATE_STATE
