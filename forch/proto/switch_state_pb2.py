...
_SWITCHSTATE_VLANACLSTATE = _descriptor.Descriptor(
  name='VlanAclState',
  full_name='SwitchState.VlanAclState',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='acls', full_name='SwitchState.VlanAclState.acls', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='packet_rate_state', full_name='SwitchState.VlanAclState.packet_rate_state', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SWITCHSTATE = _descriptor.Descriptor(
  ...
  nested_types=[_SWITCHSTATE_SWITCHESENTRY, _SWITCHSTATE_SWITCHNODE, _SWITCHSTATE_PORT, _SWITCHSTATE_PORTINFO, _SWITCHSTATE_PATHSTATE, _SWITCHSTATE_VLANACLSTATE, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_SWITCHSTATE_SWITCHNODE_VLANSENTRY.fields_by_name['value'].message_type = _SWITCHSTATE_VLANACLSTATE
...
_SWITCHSTATE_PORT.fields_by_name['vlan'].message_type = forch_dot_proto_dot_vlan__state__pb2._VLANSTATE
...
_SWITCHSTATE_VLANACLSTATE.fields_by_name['acls'].message_type = forch_dot_proto_dot_acl__state__pb2._ACLSTATE
_SWITCHSTATE_VLANACLSTATE.fields_by_name['packet_rate_state'].enum_type = forch_dot_proto_dot_shared__constants__pb2._STATE_STATE
_SWITCHSTATE_VLANACLSTATE.containing_type = _SWITCHSTATE
...
SwitchState = _reflection.GeneratedProtocolMessageType('SwitchState', (_message.Message,), {
  ...
  'SwitchNode' : _reflection.GeneratedProtocolMessageType('SwitchNode', (_message.Message,), {
    ...
    'AccessPortMacsEntry' : _reflection.GeneratedProtocolMessageType('AccessPortMacsEntry', (_message.Message,), {
    ...
    'StackingPortMacsEntry' : _reflection.GeneratedProtocolMessageType('StackingPortMacsEntry', (_message.Message,), {
    ...
    'EgressPortMacsEntry' : _reflection.GeneratedProtocolMessageType('EgressPortMacsEntry', (_message.Message,), {
  ...
  'PathState' : _reflection.GeneratedProtocolMessageType('PathState', (_message.Message,), {
  ...
  'VlanAclState' : _reflection.GeneratedProtocolMessageType('VlanAclState', (_message.Message,), {
    'DESCRIPTOR' : _SWITCHSTATE_VLANACLSTATE,
    '__module__' : 'forch.proto.switch_state_pb2'
    # @@protoc_insertion_point(class_scope:SwitchState.VlanAclState)
    })
  ,
...
_sym_db.RegisterMessage(SwitchState.VlanAclState)
