...
_SWITCHSTATE_VLANSTATE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='packet_rate_state', full_name='SwitchState.VLANState.packet_rate_state', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SWITCHSTATE_PORT.fields_by_name['vlan'].message_type = _SWITCHSTATE_VLANSTATE
...
_SWITCHSTATE_VLANSTATE.fields_by_name['packet_rate_state'].enum_type = forch_dot_proto_dot_shared__constants__pb2._STATE_STATE
