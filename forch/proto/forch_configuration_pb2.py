...
_FORCHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='facuet_config_processing', full_name='ForchConfig.facuet_config_processing', index=8,
...
_FORCHCONFIG.fields_by_name['facuet_config_processing'].message_type = _FAUCETCONFIGPROCESSING
