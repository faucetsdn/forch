...
_FORCHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='faucet_config_processing', full_name='ForchConfig.faucet_config_processing', index=8,
...
_FAUCETCONFIGPROCESSING = _descriptor.Descriptor(
  name='FaucetConfigProcessing',
  full_name='FaucetConfigProcessing',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='config_hash_max_retry', full_name='FaucetConfigProcessing.config_hash_max_retry', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FORCHCONFIG.fields_by_name['faucet_config_processing'].message_type = _FAUCETCONFIGPROCESSING
...
DESCRIPTOR.message_types_by_name['FaucetConfigProcessing'] = _FAUCETCONFIGPROCESSING
...
FaucetConfigProcessing = _reflection.GeneratedProtocolMessageType('FaucetConfigProcessing', (_message.Message,), {
  'DESCRIPTOR' : _FAUCETCONFIGPROCESSING,
  '__module__' : 'forch.proto.forch_configuration_pb2'
  # @@protoc_insertion_point(class_scope:FaucetConfigProcessing)
  })
