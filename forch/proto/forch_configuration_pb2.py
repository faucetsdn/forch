...
OrchestrationConfig = _reflection.GeneratedProtocolMessageType('OrchestrationConfig', (_message.Message,), dict(
  ...
  SequesterConfig = _reflection.GeneratedProtocolMessageType('SequesterConfig', (_message.Message,), dict(
    ...
    TestResultDeviceStateTransition = _reflection.GeneratedProtocolMessageType('TestResultDeviceStateTransition', (_message.Message,), dict(
...
_DATAPLANEMONITORING_VLANPKTPERSECTHRESHOLDSENTRY.has_options = True
_DATAPLANEMONITORING_VLANPKTPERSECTHRESHOLDSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
