...
_NETWORKSTATE_NAMEDMATCHRULESENTRY.has_options = True
_NETWORKSTATE_NAMEDMATCHRULESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_NETWORKSTATE_DEVICEMACBEHAVIORSENTRY.has_options = True
_NETWORKSTATE_DEVICEMACBEHAVIORSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
