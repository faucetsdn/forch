...
HostList = _reflection.GeneratedProtocolMessageType('HostList', (_message.Message,), {
  ...
  'EthSrcsEntry' : _reflection.GeneratedProtocolMessageType('EthSrcsEntry', (_message.Message,), {
  ...
  'EthDstsEntry' : _reflection.GeneratedProtocolMessageType('EthDstsEntry', (_message.Message,), {
  ...
  'RadiusResult' : _reflection.GeneratedProtocolMessageType('RadiusResult', (_message.Message,), {
