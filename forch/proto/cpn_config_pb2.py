...
CpnConfig = _reflection.GeneratedProtocolMessageType('CpnConfig', (_message.Message,), {
...
CpnAttributes = _reflection.GeneratedProtocolMessageType('CpnAttributes', (_message.Message,), {
